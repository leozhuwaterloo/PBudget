...
const en = {
  ...
  "accounts.removeConfirm": "Permanently remove {name}? This deletes its accounts and all transactions here, and revokes the connection at Plaid. This cannot be undone.",
  "accounts.removeDone": "Removed {name} and its data.",
  ...
  "dash.categories.other": "Everything else",
  "dash.categories.total": "Total",
  "dash.categories.aria": "Donut chart of spending share by category",
  "dash.stat.spent": "Spent this month",
  "dash.stat.vsPrev": "vs. previous month",
  "dash.stat.avg": "Monthly average",
  "dash.stat.avgSub": "Across active months",
  "dash.stat.budget": "Budget used",
  "dash.stat.noBudget": "No budgets set yet",
  "dash.stat.review": "Needs review",
  "dash.stat.reviewSub": "Open items to resolve",
  "dash.stat.reviewClear": "All caught up",
  "dash.trend.click": "Tip: click a month to jump to it",
  ...
  "privacy.intro": "This policy explains what PBudget collects, how it is used, and the third parties that process it. It applies to pbudget.ppvnx.com.",
  "privacy.collectTitle": "What we collect",
  "privacy.collectBody": "Your email address, and — once you link a bank — the account balances and transaction history returned by Plaid. We do not collect or store your bank login credentials; those are handled entirely by Plaid.",
  "privacy.thirdTitle": "Who processes your data",
  "privacy.thirdBody": "We share data only with the providers that make the service work: Plaid (secure bank connections and transaction data), Stripe (subscription payments — we never see your card number), and Resend (verification and account emails). We do not sell your data or use it for advertising.",
  "privacy.storeTitle": "How it is stored",
  "privacy.storeBody": "Account and transaction details are encrypted at rest. We retain your data only while your account exists.",
  "privacy.controlTitle": "Your choices",
  "privacy.controlBody": "You can disconnect a bank at any time from the Accounts page, and you can delete your account to remove your data from PBudget. Your underlying data always remains available in your bank and in Plaid.",
  ...
  "review.categoryReasonPlaceholder": "Reason for this category…",
  ...
  "merge.search": "Search transactions…",
  "merge.loading": "Loading candidates…",
  "merge.none": "No transactions available to merge.",
  "merge.noneMatch": "No transactions match your search.",
  ...
  "landing.finalBody": "Free for a month with 1 bank connection. Then $3/mo for up to 6 connections, or $10/mo for 20.",
