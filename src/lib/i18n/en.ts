...
const en = {
  ...
  "review.analyzeHint": "Re-run auto-match, vendor matching, and the suspicion rules over all your transactions — the same analysis a sync does, without fetching from Plaid.",
