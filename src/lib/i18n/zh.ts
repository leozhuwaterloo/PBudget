...
const zh: Messages = {
  ...
  "accounts.remove": "移除",
  "accounts.removeConfirm": "确定要永久移除 {name} 吗？这将删除其账户及此处的全部交易，并在 Plaid 处撤销该连接。此操作无法撤销。",
  "accounts.removeDone": "已移除 {name} 及其数据。",
  ...
  "accounts.removed": "此连接已被移除（免费试用结束或订阅到期）。您的数据已保留——订阅并重新连接后即可再次同步。",
  ...
  "cust.billing.trialEnded": "您的免费试用已结束。订阅后可重新连接银行——您的数据已保留。",
  ...
  "dash.stat.spent": "本月支出",
  "dash.stat.vsPrev": "较上月",
  "dash.stat.avg": "月均支出",
  "dash.stat.avgSub": "按有支出的月份计算",
  "dash.stat.budget": "预算使用",
  "dash.stat.noBudget": "尚未设置预算",
  "dash.stat.review": "待审核",
  "dash.stat.reviewSub": "待处理项目",
  "dash.stat.reviewClear": "全部处理完毕",
  "dash.trend.click": "提示：点击某月即可跳转",
  ...
  "terms.p2": "PBudget 对您的任何数据概不负责。您对自己的数据负全部责任，包括任何丢失、损坏、不准确或未经授权的访问。在法律允许的最大范围内，PBudget 及其运营者不对因您使用本服务、或因数据的存储、传输或丢失而产生的任何损害承担任何责任。",
  "terms.p3": "创建账户即表示您确认并接受这些条款。",
  "terms.back": "← 返回注册",
  // 隐私政策
  "privacy.title": "隐私政策",
  "privacy.updated": "最后更新：2026 年 7 月",
  "privacy.intro": "本政策说明 PBudget 收集哪些信息、如何使用，以及处理这些信息的第三方。适用于 pbudget.ppvnx.com。",
  "privacy.collectTitle": "我们收集的信息",
  "privacy.collectBody": "您的电子邮箱地址，以及在您连接银行后由 Plaid 返回的账户余额和交易记录。我们不会收集或存储您的银行登录凭据，这些完全由 Plaid 处理。",
  "privacy.thirdTitle": "谁处理您的数据",
  "privacy.thirdBody": "我们仅与使服务得以运行的提供商共享数据：Plaid（安全的银行连接与交易数据）、Stripe（订阅付款——我们绝不会看到您的卡号）以及 Resend（验证与账户邮件）。我们不会出售您的数据，也不会将其用于广告。",
  "privacy.storeTitle": "如何存储",
  "privacy.storeBody": "账户和交易详情在存储时均已加密。我们仅在您的账户存在期间保留您的数据。",
  "privacy.controlTitle": "您的选择",
  "privacy.controlBody": "您可以随时在“账户”页面断开银行连接，也可以删除账户以从 PBudget 移除您的数据。您的原始数据始终保留在您的银行和 Plaid 中。",
  ...
  "review.analyze": "分析",
  "review.analyzeHint": "对您过去一年的交易重新运行自动配对、商户匹配和可疑规则 —— 与同步所做的分析相同，但不从 Plaid 拉取数据。",
  "review.analyzeDone": "分析完成 —— {groups} 条待确认合并建议，{flags} 项待处理。",
  ...
  "landing.finalBody": "首月免费，含 1 个银行连接。之后 $3/月最多 6 个连接，或 $10/月 20 个连接。",
